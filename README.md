...
```
Excel_to_XML/
├─ api/              # API клиент, бэкенды, построитель payload
├─ db/               # SQLite менеджер, репозитории, схема
├─ docs/             # Документация
├─ exporters/        # Экспорт в XML, протоколы
├─ importers/        # Импорт из XLSX, XML
├─ journal/          # Журнал проверки знаний
├─ network/          # Сетевые утилиты
├─ protocol/         # Менеджеры комиссий и программ
├─ resources/        # Статические ресурсы (иконки, изображения)
├─ schema/           # XSD схемы
├─ tabs/             # UI вкладки (PySide6)
├─ templates/        # Шаблоны документов
├─ tests/            # Тесты
├─ utils/            # Утилиты (крипто, логирование, пути, прокси)
├─ main.py           # Точка входа
