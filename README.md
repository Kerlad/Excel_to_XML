...
- **TLS-верификация**: при отключении — модальное подтверждение, красный индикатор, предупреждение при старте и при первой отправке за сессию. Все события в audit.log
...
- Режим объединённой программы В: вместо сбора данных по программам №6-29 подставляется единый текст с номером и часами
